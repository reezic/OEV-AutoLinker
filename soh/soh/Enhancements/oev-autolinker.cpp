...
const OEVEntranceData oevEntranceData[] = {
    ...
    { "Lake Hylia River Exit",          "#LakeHylia",   "color_LakeHylia",   "Lake Hylia" },
    ...
    { "Gerudo Fortress East Exit",       "#GerudoFortress", "color_GerudoValley",         "Gerudo Valley" },
    { "Gerudo Fortress Gate Exit",       "#GerudoFortress", "color_GerudoValley",         "Gerudo Valley" },
    { "GF Outside Training Ground",      "#GerudoFortress", "color_GerudoValley",         "Gerudo Valley" },
    { "GF Storms Grotto Entry",          "#GerudoFortress", "color_Grotto",               "Gerudo Valley" },
    ...
    { "MK Entrance Guard House Entry",    "#MarketEntrance",        "color_HyruleMarket", "Hyrule Market" },
